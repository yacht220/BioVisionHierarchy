...
// These values need to be available globally
	...
	bool rFlag = FALSE, lFlag = FALSE;//±êÊ¶ÓïÒô¿ØÖÆÖĞµÄ×óÓÒ×ª¶¯

	int rLoop = 0, lLoop = 0;//±êÊ¶ÒòÓïÒô¿ØÖÆÒıÆğµÄ×ª¶¯´ÎÊı
///////////////////////////////////////////////////////////////////////////////
// COGLView
...
///////////////////////////////////////////////////////////////////////////////
	...
	switch(flag)
	{
		...
		case 3://run flag
			...
			LoadBVH("..\\YachtBVH_voice_cmd&ctrl\\BVH\\Run.bvh",m_Skeleton);//¼ÓÔØbvhÊı¾İÎÄ¼ş
			break;
		case 4://walk flag
			DestroySkeleton(m_Skeleton);//Çå¿Õ¹Ç÷À´æ´¢¿Õ¼ä
			LoadBVH("..\\YachtBVH_voice_cmd&ctrl\\BVH\\Walk-Normal.bvh",m_Skeleton);//¼ÓÔØbvhÊı¾İÎÄ¼ş
			break;
		case 5://fight flag
			DestroySkeleton(m_Skeleton);//Çå¿Õ¹Ç÷À´æ´¢¿Õ¼ä
			LoadBVH("..\\YachtBVH_voice_cmd&ctrl\\BVH\\DOUBLE PUNCH 1.bvh",m_Skeleton);//¼ÓÔØbvhÊı¾İÎÄ¼ş
			break;
		case 6://stand flag
			DestroySkeleton(m_Skeleton);//Çå¿Õ¹Ç÷À´æ´¢¿Õ¼ä
			LoadBVH("..\\YachtBVH_voice_cmd&ctrl\\BVH\\T.bvh",m_Skeleton);//¼ÓÔØbvhÊı¾İÎÄ¼ş
			break;
		case 7://walk slowly flag
			DestroySkeleton(m_Skeleton);//Çå¿Õ¹Ç÷À´æ´¢¿Õ¼ä
			LoadBVH("..\\YachtBVH_voice_cmd&ctrl\\BVH\\Walk-Slow.bvh",m_Skeleton);//¼ÓÔØbvhÊı¾İÎÄ¼ş
			break;
		case 8://dance flag
			DestroySkeleton(m_Skeleton);//Çå¿Õ¹Ç÷À´æ´¢¿Õ¼ä
			LoadBVH("..\\YachtBVH_voice_cmd&ctrl\\BVH\\ballet1.bvh",m_Skeleton);//¼ÓÔØbvhÊı¾İÎÄ¼ş
			break;
		case 9://run slowly flag
			DestroySkeleton(m_Skeleton);//Çå¿Õ¹Ç÷À´æ´¢¿Õ¼ä
			LoadBVH("..\\YachtBVH_voice_cmd&ctrl\\BVH\\Jog.bvh",m_Skeleton);//¼ÓÔØbvhÊı¾İÎÄ¼ş
			break;
	}
	///////////////////////////////////////////////////////////////
